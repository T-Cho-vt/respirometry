...
Beetle_abdo = imread('Beetle_abdo.jpg');
Beetle_points = imread('Beetle_points.jpg');
...
figure, 
    ...
    subplot(7,2,[1; 3]), hold on
        imshow(Beetle_abdo),
        text(0,-70,'(a)','fontsize',20),
    hold off
    
    subplot(7,2,[2; 4]), hold on
        imshow(Beetle_points),
        text(0,-70,'(b)','fontsize',20),
    hold off
    
    subplot(7,2,[3 4] +2), hold on,
    ...
    subplot(7,2,[9 10 11 12] +2), hold on,
        plot(observ_sig,'color',[0,0,0]+0.45,'linewidth', 1.5),
...
xlim([1 Params.supp])
ylim([0 0.07])
set(gca,'xtick',[1 Params.supp/2 Params.supp],'xticklabel',{num2str((Params.delay)/10),num2str((Params.delay+Params.supp/2)/10),[num2str((Params.delay+Params.supp)/10),'(s)']},'fontsize',15)
set(gca,'ytick', 0.01:0.01:0.07)
set(gca,'fontsize',20)
